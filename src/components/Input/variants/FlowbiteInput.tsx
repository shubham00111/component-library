  ...
  return (
    <div className="flex flex-col gap-1.5 font-sans">
      ...
      <input
        ...
        className={[
          "py-2 px-3 text-[0.9375rem] font-sans text-gray-900 dark:text-white bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm outline-none w-full transition-all duration-200",
          "placeholder:text-gray-500 dark:placeholder:text-gray-400",
          "focus:border-[#1c64f2] focus:shadow-[0_0_0_3px_rgba(28,100,242,0.3)] dark:focus:border-blue-500 dark:focus:shadow-[0_0_0_3px_rgba(59,130,246,0.3)]",
