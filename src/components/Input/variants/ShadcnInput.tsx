  ...
  return (
    <div className="flex flex-col gap-1.5 font-sans">
      ...
      <input
        ...
        className={[
          "py-2 px-3 text-[0.9375rem] font-sans text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-[6px] outline-none w-full transition-[border-color,box-shadow] duration-150",
